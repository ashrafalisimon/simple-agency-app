    ...
    return (
        <div className="max-w-screen-xl container mx-auto py-20 px-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                {
                    priceingPlans.map((plan) => (
                        <div key={plan.name} className="bg-white shadow-sm rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                            {/* top */}
                                ...
                                <ul className="text-center text-gray-600">
                                    {
                                        plan.features.map((feature, index) => (
                                            <li key={index} className="flex items-center mb-2">
                                                <IoCheckmark className="text-green-600 mr-2" />
                                                {feature}
                                            </li>
                                        ))
                                    }
