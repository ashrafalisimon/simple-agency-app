    ...
    return (
        <div className="bg-gray-200">
            <div className="max-w-screen-xl container mx-auto py-20 px-5">
                <HeadingSection subHeading="FAQs"
                ...
                <div className="w-full max-w-4xl mx-auto">
                    {
                        faqs.map((faq) => (
                            <div key={faq.id} className="border border-gray-300 mb-4">
                                {/* questions */}
                                <div className="cursor-pointer flex justify-between items-center p-4 bg-gray-50 hover:bg-gray-100 transition duration-300" onClick={() => toggleFAQ(faq.id)}>
